...
docker exec -it ${SUPERSET_CONTAINER_NAME} superset fab create-admin --username \${SUPERSET_ADMIN_USERNAME} --password \${SUPERSET_ADMIN_PASSWORD} --firstname Superset --lastname Admin --email \${SUPERSET_ADMIN_EMAIL}
